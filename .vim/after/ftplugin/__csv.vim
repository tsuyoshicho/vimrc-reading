" based on https://vim.fandom.com/wiki/Working_with_CSV_files
" Change:
"  * ftplugin to after/ftplugin (additional setting)
"  * function use only s: (not global)
...
command! -buffer -nargs=1 Csv call s:CSVH(<args>)
